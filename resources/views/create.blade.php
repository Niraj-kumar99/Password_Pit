...
<div class="container text-center">
    ...
    <form autocomplete="off" action="save_site">
        ...
        <input type="password" name="password" placeholder="Enter password" class="form-control" onmouseover="this.type='text'" onmouseout="this.type='password'" >
